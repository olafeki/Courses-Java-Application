...
public class GraphicDesign extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customeradapter = new CustomAdapter(GraphicDesign.this, patientList);
        recyclerView.setAdapter(customeradapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(GraphicDesign.this));
        storedatainarray();
    }
    ...
    void storedatainarray() {
        Cursor cursor = my_db.readgraphdata();
