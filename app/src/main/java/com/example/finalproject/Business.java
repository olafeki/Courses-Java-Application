...
public class Business extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customeradapter = new CustomAdapter(Business.this, patientList);
        recyclerView.setAdapter(customeradapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(Business.this));
        storedatainarray();
        setUpRecyclerView();
    }
    ...
    void storedatainarray() {
        Cursor cursor = my_db.readbusinessdata();
